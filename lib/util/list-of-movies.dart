final List movies = [
  ...
  [
    "Archenemy",
    "Adam Egypt Mortimer",
    "Joe Manganiello, Skylan Brooks, Zolee Griggs, Paul Scheer, Amy Seimetz, Glenn Howerton",
    "United States, United Kingdom",
    "Superhero, mystery, thriller[3]"
  ],
  [
    "Asuraguru",
    "A.Raajdheep",
    "Vikram Prabhu, Mahima Nambiar, Subbaraju, Yogi Babu",
    "India",
    "Action thriller[4]"
  ],
  [
  ...
  [
    "Attack",
    "Lakshya Raj Anand",
    "John Abraham, Jacqueline Fernandez, Rakul Preet Singh",
    "India",
    "Action thriller[6][7]"
  ],
  [
    "Ava",
    "Tate Taylor",
    "Jessica Chastain, John Malkovich, Common, Geena Davis, Colin Farrell, Ioan Gruffudd, Joan Chen",
    "United States",
    "Action thriller[8][9]"
  ],
  [
    "Bad Boys for Life",
    "Adil & Bilall",
    "Will Smith, Martin Lawrence, Paola Núñez, Vanessa Hudgens, Alexander Ludwig, Charles Melton, Jacob Scipio, Kate del Castillo, Nicky Jam, Joe Pantoliano",
    "United States",
    "Action comedy[10]"
  ],
  [
    "Bamfaad",
    "Ranjan Chandel",
    "Aditya Rawal, Shalini Pandey, Vijay Varma",
    "India",
    "Romance, action[11]"
  ],
  [
  ...
  [
    ...
    "United States",
    "Sci-fi, action thriller[14]"
  ],
  [
    "Chick Fight",
    "Paul Leyden",
    "Malin Åkerman, Alec Baldwin, Bella Thorne",
    "United States",
    "Action comedy[15]"
  ],
  [
    "Coffee & Kareem",
    "Michael Dowse",
    "Ed Helms, Terrence Little Gardenhigh, Betty Gilpin, Taraji P. Henson",
    "United States",
    "Action comedy[16]"
  ],
  [
    "Cut Throat City",
    "RZA",
    "Shameik Moore, Kat Graham, Wesley Snipes, T.I.",
    "United States",
    "Heist[17]"
  ],
  [
  ...
  [
    "Disco Raja",
    "Vi Anand",
    "Payal Rajput, Nabha Natesh, Tanya Hope, Bobby Simha",
    "India",
    "Sci-fi action [19][20]"
  ],
  [
    "Earth and Blood",
    "Julien Leclercq",
    "Sami Bouajila, Eriq Ebouaney, Samy Seghir",
    "France",
    "Action thriller[21]"
  ],
  [
    "Enter the Fat Dragon",
    "Kenji Tanigaki, Wong Jing",
    "Donnie Yen, Teresa Mo, Wong Jing, Niki Chow",
    "China",
    "Martial arts comedy[22]"
  ],
  [
    "Extraction",
    "Sam Hargrave",
  ...
  ["Fatman", "Eshom Nelms", null, null, null],
  [
    "Ian Nelms",
    "Mel Gibson, Walton Goggins, Marianne Jean-Baptiste",
    "United State",
    "Action, dark comedy[25][26]",
    null
  ],
  [
    "Force of Nature",
    "Michael Polish",
    "Emile Hirsch, Kate Bosworth, Mel Gibson, Stephanie Cayo",
    "United States",
    "Action[27]"
  ],
  [
    ...
    "Supernatural horror, war thriller[28]"
  ],
  [
    "Greyhound",
    "Aaron Schneider",
    ...
    "United States",
    "War, action, thriller[29]"
  ],
  [
    "Guns Akimbo",
    "Jason Lei Howden",
    "Daniel Radcliffe, Samara Weaving, Natasha Liu Bordizzo, Grant Bowler",
  ...
  [
    "Guns of Banaras",
    "Sekhar Suri",
    "Karan Nath, Nathalia Kaur, Abhimanyu Singh, Ganesh Venkatraman, Shilpa Shirodkar, Zarina Wahab, Mohan Agashe",
    "India",
    "Action thriller[31]"
  ],
  [
    "Hitman: Agent Jun",
    "Choi Won-sub",
    "Kwon Sang-woo, Jung Joon-ho, Hwang Woo-seul-hye, Lee Yi-kyung",
    "South Korea",
    "Action comedy[32][33]"
  ],
  [
    "Honest Thief",
    "Mark Williams",
    "Liam Neeson, Kate Walsh, Jai Courtney, Jeffrey Donovan",
    "United States",
    "Action thriller[34]"
  ],
  [
  ...
  [
    "Jiu Jitsu",
    "Dimitri Logothetis",
    "Alain Moussi, Frank Grillo, JuJu Chan, Tony Jaa, Nicolas Cage",
    "United States",
    "Sci-fi, martial arts[36]"
  ],
  ["Justice League Dark: Apokolips War", "Matt Peters,", null, null, null],
  [
    "Christina Sotta",
    "Jerry O'Connell, Matt Ryan, Jason O'Mara, Taissa Farmiga, Stuart Allan, Tony Todd, Ray Chase, Rosario Dawson, Shemar Moore, Christopher Gorham, Rebecca Romijn, Rainn Wilson",
    "United States",
    "Animated, superhero[37]",
    null
  ],
  [
    "Love and Monsters",
    ...
    "United States",
    "Action, adventure, fantasy, rom-com[38]"
  ],
  [
    "Mafia: Chapter 1",
    "Karthick Naren",
    "Arun Vijay, Prasanna, Priya Bhavani Shankar, Thalaivasal Vijay",
    "India",
    "Action, crime[39]"
  ],
  [
    ...
    "India",
    "Action, romance, thriller[40]"
  ],
  [
    "Monster Hunter",
    "Paul W. S. Anderson",
    "Milla Jovovich, Tony Jaa, Tip \"T. I.\" Harris, Meagan Good",
    "United States",
    "Action thriller[41]"
  ],
  [
    ...
    "Ethan Spaulding",
    "Patrick Seitz, Steve Blum, Jordan Rodrigues, Darin De Paul, Joel McHale, Jennifer Carpenter",
    "United States",
    "Animated, action, martial arts, fantasy[42]"
  ],
  [
    "Mulan",
    "Niki Caro",
    "Liu Yifei, Donnie Yen, Jason Scott Lee, Yoson An",
    "United States",
    "Action drama[43]"
  ],
  [
    "My Spy",
    "Peter Segal",
    "Dave Bautista, Chloe Coleman, Kristen Schaal, Ken Jeong",
    "United States",
    "Action comedy[44]"
  ],
  [
    "Palasa 1978",
    "Karuna Kumar",
    "Rakshith, Nakshatra, Raghu Kunche",
    "India",
    "Period action[45]"
  ],
  [
    "Pasal Kau!",
    "Adrian Teh",
    "Hairul Azreen, Janna Nick, Amerul Affendi, Namron, Henley Hii",
    "Malaysia",
    "Action, rom-com[46][47]"
  ],
  [
    "Peninsula",
    "Yeon Sang-ho",
  ...
  [
    ...
    "United States",
    "Superhero action thriller[49]"
  ],
  [
    "Rogue",
    "M. J. Bassett",
    "Megan Fox, Philip Winchester",
    "United States",
    "[50]"
  ],
  [
    "Sarileru Neekevvaru",
    "Anil Ravipudi",
    "Mahesh Babu, Rashmika Mandanna, Vijayashanti, Prakash Raj, Rajendra Prasad",
    "India",
    "Action comedy[51]"
  ],
  [
    "Shivarjuna",
    "Shiva Thejas",
    "Chiranjeevi Sarja, Amrutha Iyengar, Akshatha Srinivas, Kishore",
    "India",
    "Action, family[52]"
  ],
  [
  ...
  [
    ...
    "Peter Berg",
    "Mark Wahlberg, Winston Duke, Alan Arkin, Iliza Shlesinger, Bokeem Woodbine, Marc Maron, Post Malone",
    "United States",
    "Action, comedy[54]"
  ],
  [
  ...
  [
    ...
    "Chris Palmer",
    "Darren Criss, Alexandra Daddario, Zachary Quinto",
    "United States",
    "Animated, superhero[57]"
  ],
  [
    "Superman: Red Son",
    "Sam Liu",
    "Jason Isaacs, Roger Craig Smith, Diedrich Bader, Amy Acker, Vanessa Marshall, Paul Williams",
    "United States",
    "Animated, superhero[58]"
  ],
  [
    "Tanhaji",
    "Om Raut",
    "Ajay Devgn, Saif Ali Khan, Kajol, Neha Sharma",
    "India",
    "biographical action[59]"
  ],
  [
    "Tenet",
    "Christopher Nolan",
    ...
    "Action, sci-fi, spy thriller[60]"
  ],
  [
    "The Gentlemen",
    "Guy Ritchie",
    "Matthew McConaughey, Charlie Hunnam, Henry Golding, Michelle Dockery",
    "United Kingdom, United States",
    "Crime, action, comedy[61]"
  ],
  [
    "The Last Days of American Crime",
    "Olivier Megaton",
    "Édgar Ramírez, Anna Brewster, Michael Pitt, Sharlto Copley",
    "United States",
    "Action thriller[62]"
  ],
  [
    ...
    "Charlize Theron, KiKi Layne, Marwan Kenzari, Matthias Schoenaerts, Chiwetel Ejiofor",
    "United States",
    "Action thriller[63]"
  ],
  [
  ...
  [
    "The Swordsman",
    "Choi Jae-hoon",
    "Jang Hyuk, Kim Hyun-soo, Joe Taslim",
    "South Korea",
    "[65]"
  ],
  [
    "The Tax Collector",
    "David Ayer",
    "Bobby Soto, Cinthya Carmona, George Lopez, Shia LaBeouf",
    "United States",
    "Action thriller [66]"
  ],
  [
  ...
  [
    "Vanguard",
    "Stanley Tong",
    "Jackie Chan, Ai Lun, Yang Yang, Miya Muqi",
    "China",
    "Action, adventure[68]"
  ],
  [
    "We Can Be Heroes",
    "Robert Rodriguez",
    "Priyanka Chopra Jonas, Pedro Pascal, YaYa Gosselin, Boyd Holbrook, Adriana Barraza, Haley Reinhart, Sung Kang, Taylor Dooley, Christian Slater",
    "United States",
    "Superhero[69]"
  ],
  [
